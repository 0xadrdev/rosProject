...
#include "tutorial_interfaces/msg/detail/ball__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::Ball & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::Ball & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::Ball *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::Ball *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_Ball__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, Ball)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_Ball__handle;
}
