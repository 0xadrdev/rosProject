...
#include "tutorial_interfaces/msg/detail/vel__rosidl_typesupport_fastrtps_c.h"
...
using _Vel__ros_msg_type = tutorial_interfaces__msg__Vel;
...
size_t get_serialized_size_tutorial_interfaces__msg__Vel(
  const void * untyped_ros_message,
...
static uint32_t _Vel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__Vel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__Vel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Vel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__msg__Vel(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, Vel)() {
