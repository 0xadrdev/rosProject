...
#include "tutorial_interfaces/msg/detail/ball__rosidl_typesupport_fastrtps_c.h"
...
using _Ball__ros_msg_type = tutorial_interfaces__msg__Ball;
...
size_t get_serialized_size_tutorial_interfaces__msg__Ball(
  const void * untyped_ros_message,
...
static uint32_t _Ball__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__Ball(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__Ball(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Ball__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__msg__Ball(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, Ball)() {
